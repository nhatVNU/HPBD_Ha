...
const config = {
    name: "Bảo Hà", // actual name of the recipient (Mandatory)
...
CTAtext.innerHTML = "Nhấn vào đèn này nè ! kkk";
...
button.addEventListener("click",function(){
    ...
    if(button.classList.contains("switch")) {
        ...
        */
        ...
        light.play();
        transition(darkroom);
        CTAtext.innerHTML = "Mở cửa này nè Bẻo Hà <(-.-)>";
        setTimeout(function() {
        ...
        */
        ...
        door.play();
        transition(hallway);
        CTAtext.innerHTML = "Mở quà đi nè ";
        setTimeout(function() {
        ...
        */
        ...
        document.querySelector(".HBD").textContent = "Chúc mừng sinh nhật";
